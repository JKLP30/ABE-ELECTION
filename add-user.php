        ...
        <div class="panel-body">
          <form action="process.php" method="post" enctype="multipart/form-data" name="form1">
            <div class="form-group">
              ...
              <input type="number" min="0" class="form-control" name="usn" id="usn" required>
            </div>
            <div class="form-group">
            ...
            <input name="btnAddUser" type="submit" class="btn btn-primary" id="btnAddUser" value="Add User">
          </form>
        </div>
  </div>
</div>
